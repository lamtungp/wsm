            ...
            {({ handleChange, handleSubmit, values, errors, touched }) => (
              ...
              >
                ...
                <Form.Group>
                  <CRow>
                    <CCol lg="4">
                      ...
                      <Form.Control name="phoneNumber" type="text" value={values.phoneNumber} onChange={handleChange} />
                    </CCol>
                  </CRow>
                </Form.Group>
                <Form.Group>
                ...
                <Form.Group>
                  ...
                  {errors.dayIn && touched.dayIn ? <Form.Text className="text-danger">{errors.dayIn}</Form.Text> : null}
                </Form.Group>
                <Form.Group>
                  <CRow>
                    <CCol lg="4">
                ...
                <Form.Group>
                  <CRow>
                    <CCol lg="4">
                      ...
                      <Form.Control name="contractTerm" as="select" value={values.contractTerm} onChange={handleChange}>
                ...
                <Form.Group>
                  <CRow>
                    <CCol lg="4">
                      ...
                      <Form.Control name="departmentId" as="select" value={values.departmentId} onChange={handleChange}>
                        {!!departments ? (
                          <>
