  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Information component" />
      </Helmet>
      <CRow>
        <CCol xs="12">
          <CCard>
                  ...
                  <div style={{ display: 'inline-block', width: '100%' }}>
                    ...
                    <table className="table table-striped table-bordered table-hover">
                      <tbody>
                        <tr>
                          <th>
                            <span className="translation_missing" title="translation missing: vi.profiles.show.group">
                              Group
                            </span>
                          </th>
                          <th>L1</th>
                        ...
                        <tr>
                          ...
                          <td>
                            Nguyễn Xuân Cương, Trần Đức Thắng, Nguyễn Xuân Mạnh, Nguyễn Hoàng Nam, Nguyễn Trung Thọ,
                            Phạm Thu Hà,
                          </td>
                        </tr>
                      </tbody>
